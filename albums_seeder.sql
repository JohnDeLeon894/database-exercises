...
values ('Michael Jackson', 'Thriller', 1982,'Pop, rock, R&B', 47.3),
 ...
 ('Eagles', 'Their Greatest Hits', 41.2,
        'Country rock, soft rock, folk rock', 1976),
 ...
 ('Whitney Houston / Various artists', 'The Bodyguard',
        1992, 'R&B, soul, pop, soundtrack', 24.2),


 ('Pink Floyd', 'The Dark Side of the Moon', 1973,
        'Progressive rock', 24.2),
